(function(Editor, markdownit, WebUploader){
    ...
    var ToolLink = function(){
        var self = this;
        this.$win = $([
            '<div id="link_div" class="modal hide fade in" style="display: none; " tabindex="-1" role="dialog" aria-labelledby="editorToolImageTitle" aria-hidden="true">',
    ...
    var ToolImage = function(){
        var self = this;
        this.$win = $([
            '<div id="image_div" class="modal hide fade in" style="display: none; " tabindex="-1" role="dialog" aria-labelledby="editorToolImageTitle" aria-hidden="true">',
                '<div class="modal-header">',
                    '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>',
